...
set outfile3 = $outdir/$EXPID-em-anthro_CMIP_CEDS_gn_shipping_${yyyy}.nc
if(-e $inpfile) then
echo $inpfile
echo $outfile1
echo $outfile2
...
ncks -A -v lat,lon,time $inpfile $outfile3
 ncap2 -A -s "${EXPID}_shipping = SHP" -v $inpfile $outfile3
 ncatted -O -a long_name,${EXPID}_shipping,o,c,"Emissions of ${EXPID} from shipping sector" $outfile3
